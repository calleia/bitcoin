...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-proxymode", strprintf("If a peer requests a block that is not available locally (e.g. because it was pruned), fetch it from the P2P network and relay it back to the requesting peer (default: %u)", DEFAULT_PROXY_MODE), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
